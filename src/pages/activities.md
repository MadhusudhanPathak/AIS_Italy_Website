    ...
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="card hover-lift">
                ...
                <h4 class="font-bold text-accent mb-3 mt-6">🛤️ Track 1: AI Safety Governance</h4>
                ...
                <h4 class="font-bold text-accent mb-3">🛤️ Track 2: AI Safety Alignment</h4>
                ...
                <div class="bg-blue-50 p-4 rounded-lg mt-6 mb-6 border border-blue-100">
            ...
            <div class="card hover-lift">
                ...
                <h4 class="font-bold text-accent mb-3 mt-6">What We Cover</h4>
...
<section class="section">
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <a href="https://jobs.80000hours.org" target="_blank" class="card hover-lift hover:shadow-2xl">
                ...
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <span class="text-accent font-semibold">Browse Positions →</span>
                </div>
            </a>
            <a href="https://www.apartresearch.com" target="_blank" class="card hover-lift hover:shadow-2xl">
                <span class="text-4xl mb-3 block">🏆</span>
                ...
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <span class="text-accent font-semibold">View Competitions →</span>
                </div>
            </a>
            <a href="https://www.alignmentawards.com" target="_blank" class="card hover-lift hover:shadow-2xl">
                <span class="text-4xl mb-3 block">🎖️</span>
                <h3>Alignment Awards</h3>
                <p>Compete for recognition and prizes for your work on AI alignment and safety initiatives.</p>
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <span class="text-accent font-semibold">Learn More →</span>
                </div>
            </a>
            <a href="/community/" class="card hover-lift hover:shadow-2xl">
                <span class="text-4xl mb-3 block">📚</span>
                <h3>Learning Resources</h3>
                <p>Access our curated collection of AI safety resources, papers, guides, and educational materials.</p>
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <span class="text-accent font-semibold">Explore Resources →</span>
                </div>
            </a>
        </div>
    </div>
